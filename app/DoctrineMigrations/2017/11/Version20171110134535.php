...
class Version20171110134535 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('INSERT INTO symfony.employee (id, username, username_canonical, email, email_canonical, enabled, salt, password, last_login, confirmation_token, password_requested_at, roles, name, surname, telephone, discr) VALUES (1, \'admin\', \'admin\', \'asdad@sdadasd.sds\', \'asdad@sdadasd.sds\', 1, null, \'$2y$13$VAhEC737R6rwEVySjL0KqOdv6fx7JlBHlJdKXNUWit0ma/7u7rO6C\', \'2017-11-12 11:06:45\', null, null, \'a:1:{i:0;s:10:"ROLE_ADMIN";}\', null, null, null, \'employee\');');
        ...
        $this->addSql('INSERT INTO symfony.employee (id, username, username_canonical, email, email_canonical, enabled, salt, password, last_login, confirmation_token, password_requested_at, roles, name, surname, telephone, discr) VALUES (8, \'superAdmin\', \'superadmin\', \'superAdmin@jakubfajkus.cz\', \'superadmin@jakubfajkus.cz\', 1, null, \'$2y$13$UMn5eHV85lxOU9zWVTqqve/fG4V0PvIkvKd6Qq2/YdZr7daXnRi72\', \'2017-11-12 11:12:03\', null, null, \'a:5:{i:0;s:16:"ROLE_SUPER_ADMIN";i:1;s:10:"ROLE_ADMIN";i:2;s:12:"ROLE_MEDICAL";i:3;s:10:"ROLE_NURSE";i:4;s:11:"ROLE_DOCTOR";}\', null, null, null, \'employee\');');
